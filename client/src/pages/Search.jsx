...
const Search = () => {
  ...
  useEffect(() => {
    ...
    // 2. Debouncing: Wait 500ms after the user stops typing
    const delayDebounceFn = setTimeout(() => {
      setLoading(true);
      
      // 3. Use your custom 'api' instance
      api.get(`/api/search-theaters?query=${query}`)
        .then(res => {
          // Adjust res.data based on your backend structure
    ...
    // 4. Cleanup function: Cancels the timeout if the user types again
